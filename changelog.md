...
- Forked from `@joinmarket-webui/joinmarket-api-ts` and renamed to
  `@joinmarket-ng/joinmarket-ng-api-ts`.
...
- `contrib/jm-ng-openapi.json` and `contrib/jm-ng-openapi.yaml` are shipped
  ...
  (`@joinmarket-ng/joinmarket-ng-api-ts/openapi.json`).
...
[Unreleased]: https://github.com/joinmarket-ng/joinmarket-ng-api-ts/compare/v0.4.0...HEAD
[v0.4.0]: https://github.com/joinmarket-ng/joinmarket-ng-api-ts/releases/tag/v0.4.0
